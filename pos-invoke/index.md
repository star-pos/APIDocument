...
| 支付方式 | String | pay\_tp | “”-不限  0-银行卡  1-扫码  11-微信支付  12-支付宝支付 13-银联二维码 | 0-银行卡  1-微信  2-支付宝 | 用于第三方调用时指定支付渠道；可为空；不为空时要与交易处理码（proc\_cd）保持一致，例如：660000与1是一致的。（是否生效以交易商终开通的收款产品为准）\* |
